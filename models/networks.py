...
class SEA_Block_3(nn.Module):
    def __init__(self, in_channels, padding_type, norm_layer, use_dropout, use_bias):
        super().__init__()
    ...
    def forward(self, x):
        ...
        se_weights = self.se(conv_out)
        return x + conv_out * se_weights
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        self.Down_conv1 = DepthwiseSeparableConv(input_nc, ngf, kernel_size=7, padding=0, bias=use_bias)
        self.conv_norm=norm_layer(input_nc)
        self.relu=nn.ReLU(True)
        self.Down_conv2 = DepthwiseSeparableConv(ngf, ngf * 2, kernel_size=3, stride=2, padding=1, bias=use_bias)
        self.SA=Self_Attention_no_connect(ngf*2,'ReLU')
        self.Down_conv3 = DepthwiseSeparableConv(ngf * 2, ngf * 4, kernel_size=3, stride=2, padding=1, bias=use_bias)
        ...
        self.Sa_resnetblock_1=ResnetBlock(ngf * 4, padding_type=padding_type, norm_layer=norm_layer, use_dropout=use_dropout,use_bias=use_bias)
...
class ResnetBlock(nn.Module):
    ...
    def build_conv_block(self, dim, padding_type, norm_layer, use_dropout, use_bias):
        ...
        if padding_type == 'reflect':
            ...
            conv_block += [DeformableConv(dim, dim, kernel_size=3, padding=1)]
